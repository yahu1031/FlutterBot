module.exports = {
    ...
    execute(client, message) {
        ...
        if (message.content.includes('```')) {
            ...
            if (client.count(':') > 3) return message.channel.send('And also we assume this as code. Better you can use these links to share code.\n ***__NOTE__:*** Your message will be deleted in 5 mins. Better you could copy it before it get deleted.', client.binSites);
            return;
        }
    },
};