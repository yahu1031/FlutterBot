...
const flutterfire = 'https://firebase.flutter.dev/docs/';
...
module.exports = {
    ...
    execute(client, message, args) {
        if (docs.includes(args[0].toLowerCase())) {
        ...
        switch (args[0].toLowerCase()) {
            case 'help':
                return message.channel.send('May be you are searching for `!flutter list`, Try that.');
            case 'list':
                return message.channel.send(
                    new Discord.MessageEmbed()
                        ...
                        .addFields({
                            name: 'docs',
                            value: 'FlutterFire is a set of Flutter plugins which connect your Flutter application to Firebase.[Docs here]',
                        }, {
                            name: 'analytics',
